    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-xl mx-auto mt-10">
      {Object.entries(time).map(([key, value]) => (
        <motion.div
          ...
          className="bg-white/10 backdrop-blur-xl border border-white/20 p-4 rounded-2xl shadow-[0_0_25px_rgba(0,200,255,0.25)] text-white"
        >
          <div className="text-4xl font-extrabold">{value}</div>
          <div className="text-xs uppercase mt-1 tracking-widest text-cyan-300">{key}</div>
        </motion.div>
      ))}
    </div>
  );
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 relative z-10">
          {/* BADGE */}
          <motion.div
            className="px-6 py-2 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-lg text-white font-semibold mb-6 flex items-center gap-2"
          ...
          >
            <Link
              to="/events"
              className="px-8 py-3 rounded-xl font-bold text-lg text-white bg-gradient-to-r from-cyan-500 to-blue-600 shadow-[0_0_20px_rgba(0,200,255,0.4)] hover:shadow-[0_0_35px_rgba(0,200,255,0.6)] transition flex items-center gap-2"
            >
            ...
            <a
              href="#highlights"
              className="px-8 py-3 rounded-xl font-bold text-lg text-white bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/20 transition flex items-center gap-2"
            >
              <Play /> Highlights
            </a>
          </motion.div>
        ...
        <section className="py-28 text-center relative z-10">
          <h2 className="text-5xl font-extrabold text-cyan-300 drop-shadow-lg mb-16">Ekarikthin 2024 Movie</h2>
